# k8s-microservices
This repository comprises the kubernetes manifests for the microservices. Below is the project documentation. 

Navigate to the section for this repository [here.](#manifest-repository)
...
This repository comprises the kubernetes manifests for the microservices. Each manifests includes a deployment and svc configurations except for the frontend manifest which additionally includes ingress configuration for TLS and frontend access via a custom domain.
